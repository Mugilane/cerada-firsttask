...
import bgf from '../assets/bgf.gif'
...
<footer
  class="bg-zinc-50 text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left bg-no-repeat bg-cover" style={{backgroundImage:`URL(${bgf})`}}>
  <div
  ...
  <div class="py-10 text-center md:text-left backdrop-blur-2xl p-8">
      ...
      <div class="">
        <h6
          ...
          <span class="me-3 [&>svg]:h-4 [&>svg]:w-4">
            <img src="https://icsap.co.in/assets/cerada-footer-logo-SwyesrWA.png" alt="" className='w-20' />
          </span>
        </h6>
        <p>
         "International Conference on Sustainable Agriculture Practices and Climate Change Impacts (ICSAPCI)" <br/>
